...
public:
    ...
    enum metric_event_type_t {
        ...
        METRIC_EVENT_TYPE_EXTERNALLY_AGGREGATED_DOUBLE_SCALED_TO_LONG_DISTRIBUTION_METRIC = 58
    };
    ...
    ifx_metrics_bin_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
...
public:
    ...
    public:
        ...
        userdata_t(uint16_t p_event_id, kaitai::kstream* p__io, ifx_metrics_bin_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        bool _is_null_value_section() { value_section(); return n_value_section; };
    ...
    public:
        bool _is_null_ap_container() { ap_container(); return n_ap_container; };
    ...
    public:
        bool _is_null_histogram() { histogram(); return n_histogram; };
    ...
    public:
         ...
         * enabled.
         */
        std::vector<len_string_t*>* dimensions_names() const { return m_dimensions_names; }

        /**
         * Dimension values strings ("value" parts of key-value pairs).
         */
        std::vector<len_string_t*>* dimensions_values() const { return m_dimensions_values; }
    ...
    public:
        ...
        pair_value_count_t(kaitai::kstream* p__io, ifx_metrics_bin_t::histogram_value_count_pairs_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        ifx_metrics_bin_t* _root() const { return m__root; }
        ifx_metrics_bin_t::histogram_value_count_pairs_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        histogram_uint16_bucketed_t(kaitai::kstream* p__io, ifx_metrics_bin_t::histogram_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        histogram_value_count_pairs_t(kaitai::kstream* p__io, ifx_metrics_bin_t::histogram_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        histogram_t(kaitai::kstream* p__io, ifx_metrics_bin_t::userdata_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        pair_uint16_t(kaitai::kstream* p__io, ifx_metrics_bin_t::histogram_uint16_bucketed_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        ifx_metrics_bin_t* _root() const { return m__root; }
        ifx_metrics_bin_t::histogram_uint16_bucketed_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        single_uint64_value_t(kaitai::kstream* p__io, ifx_metrics_bin_t::userdata_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        ext_aggregated_double_value_t(kaitai::kstream* p__io, ifx_metrics_bin_t::userdata_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        ext_aggregated_uint64_value_t(kaitai::kstream* p__io, ifx_metrics_bin_t::userdata_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        single_double_value_t(kaitai::kstream* p__io, ifx_metrics_bin_t::userdata_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
    ...
    public:
        ...
        len_string_t(kaitai::kstream* p__io, ifx_metrics_bin_t::userdata_t* p__parent = 0, ifx_metrics_bin_t* p__root = 0);
