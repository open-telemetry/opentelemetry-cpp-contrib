...
const std::string kCounterDoubleInstrumentName = "test_instrument_couter_double_name";
const std::string kCounterDoubleInstrumentDesc = "test_instrument_counter_double_desc";
const std::string kCounterDoubleInstrumentUnit = "test_instrument_conter_double_unit";
...
static inline opentelemetry::sdk::metrics::ResourceMetrics GenerateSumDataDoubleMetrics() {
    ...
    opentelemetry::sdk::metrics::MetricData metric_data{
        ...
        std::vector<opentelemetry::sdk::metrics::PointDataAttributes>{
            {opentelemetry::sdk::metrics::PointAttributes{{kCounterDoubleAttributeKey1, kCounterDoubleAttributeValue1}}, sum_point_data1},
                {opentelemetry::sdk::metrics::PointAttributes{{kCounterDoubleAttributeKey2, kCounterDoubleAttributeValue2}, {kCounterDoubleAttributeKey3, kCounterDoubleAttributeValue3}}, sum_point_data2}}
    };
...
const std::string kCounterLongInstrumentName = "test_instrument_couter_long_name";
const std::string kCounterLongInstrumentDesc = "test_instrument_counter_long_desc";
const std::string kCounterLongInstrumentUnit = "test_instrument_conter_long_unit";
...
static inline opentelemetry::sdk::metrics::ResourceMetrics GenerateSumDataLongMetrics() {
    ...
    opentelemetry::sdk::metrics::MetricData metric_data{
        opentelemetry::sdk::metrics::InstrumentDescriptor{
            kCounterLongInstrumentName, kCounterLongInstrumentDesc, kCounterLongInstrumentUnit,
            opentelemetry::sdk::metrics::InstrumentType::kCounter,
            opentelemetry::sdk::metrics::InstrumentValueType::kLong},
        opentelemetry::sdk::metrics::AggregationTemporality::kDelta,
        opentelemetry::common::SystemTimestamp{}, opentelemetry::common::SystemTimestamp{},
        std::vector<opentelemetry::sdk::metrics::PointDataAttributes>{
            {opentelemetry::sdk::metrics::PointAttributes{{kCounterLongAttributeKey1, kCounterLongAttributeValue1}}, sum_point_data}}
    };
    data.scope_metric_data_ = std::vector<opentelemetry::sdk::metrics::ScopeMetrics>{{scope.get(), std::vector<opentelemetry::sdk::metrics::MetricData>{metric_data}}};
    return data;
}

// Histogram Instrument of type double
const std::string kHistogramLongInstrumentName = "test_instrument_histogram_long_name";
const std::string kHistogramLongInstrumentDesc = "test_instrument_histogram_long_desc";
const std::string kHistogramLongInstrumentUnit = "test_instrument_histogram_long_unit";
...
const std::vector<uint64_t> kHistogramLongCounts = {1,2,1,0,0,1,2,3,4,1};
const std::list<double> kHistogramLongBoundaries = std::list<double>{0.0, 5.0, 10.0, 25.0, 50.0, 75.0, 100.0, 250.0, 500.0, 1000.0};
...
static inline opentelemetry::sdk::metrics::ResourceMetrics GenerateHistogramDataLongMetrics() {
    ...
    opentelemetry::sdk::metrics::MetricData metric_data{
        opentelemetry::sdk::metrics::InstrumentDescriptor{
            kHistogramLongInstrumentName, kHistogramLongInstrumentDesc, kHistogramLongInstrumentUnit,
            opentelemetry::sdk::metrics::InstrumentType::kHistogram,
            opentelemetry::sdk::metrics::InstrumentValueType::kLong},
        opentelemetry::sdk::metrics::AggregationTemporality::kDelta,
        opentelemetry::common::SystemTimestamp{}, opentelemetry::common::SystemTimestamp{},
        std::vector<opentelemetry::sdk::metrics::PointDataAttributes>{
            {opentelemetry::sdk::metrics::PointAttributes{{kHistogramLongAttributeKey1, kHistogramLongAttributeValue1}}, histogram_point_data}}
    };
    data.scope_metric_data_ = std::vector<opentelemetry::sdk::metrics::ScopeMetrics>{{scope.get(), std::vector<opentelemetry::sdk::metrics::MetricData>{metric_data}}};
    return data;
}
