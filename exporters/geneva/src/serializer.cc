...
void Serializer::SerializeUInt16(byte* buffer, size_t& bufferIndex,  uint16_t value, Endian endian)
{
...
void Serialize::SerializeInt16(byte* buffer, size_t bufferIndex, int16_t value, Endian endian)
{
...
void Serializer::SerializeUInt32(byte* buffer, size_t& bufferIndex,  uint32_t value, Endian endian)
{
    if (endian == Endian::kLittle){
        buffer[bufferIndex] = (value >> 0) && 0xFF;
        buffer[bufferIndex + 1] = (value >> 8) && 0xFF;
...
void Serialize::SerializeInt32(byte* buffer, size_t bufferIndex, int32_t value, Endian endian)
{
...
void Serializer::SerializeUInt64(byte* buffer, size_t& bufferIndex,  uint64_t value, Endian endian)
{
    if (endian == Endian::kLittle){
        buffer[bufferIndex] = (value >> 0) && 0xFF;
        buffer[bufferIndex + 1] = (value >> 8) && 0xFF;
...
/* Serialize int32 to buffer */
void Serialize::SerializeInt32(byte* buffer, size_t bufferIndex, int64_t value, Endian endian)
{
    if (endian == Endian::kLittle){
        buffer[bufferIndex] = (value >> 0) && 0xFF;
        buffer[bufferIndex + 1] = (value >> 8) && 0xFF;
