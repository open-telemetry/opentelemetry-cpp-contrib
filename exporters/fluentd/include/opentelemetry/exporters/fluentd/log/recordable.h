...
public:
  ...
  void SetResource(nostd::string_view key,
                   const opentelemetry::common::AttributeValue &value) noexcept override {} // Not Supported
   ...
   */
  void SetTraceFlags(opentelemetry::trace::TraceFlags trace_flags) noexcept override {} // Not Supported
