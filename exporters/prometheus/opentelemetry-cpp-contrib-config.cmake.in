# .rst: opentelemetry-cpp-contrib.cmake
# --------
#
# Find the native opentelemetry-cpp-contrib includes and library.
#
# =============================================================================
...
set_and_check(${CMAKE_FIND_PACKAGE_NAME}_INCLUDE_DIRS
              "@PACKAGE_INCLUDE_INSTALL_DIR@")
set_and_check(${CMAKE_FIND_PACKAGE_NAME}_LIBRARY_DIRS
